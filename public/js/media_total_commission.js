var array_columns_choice = ['streakID','name','assigned_to','channel','actual_cost_vnd','actual_sold_value_vnd','actual_profit','actual_gp','gp_plan','collected','total_commission','status'];
var string_columns_choice = "<th>Streak ID</th><th>Campaign Name</th><th>Media</th><th>Channel</th><th>Actual Cost VND</th><th>Actual Sold Value VND</th><th>Actual Profit</th><th>Actual GP</th><th>GP Plan</th><th>Collected</th><th>Total Commission</th><th>Note</th>";
...
$(document).ready(function() {   
	...
	{		
			...
			{
				$.ajax({
					url: "/streak_new/public/report/media/total-commission-media",		
					type: 'POST',
					dataType: 'JSON',
