...
function exportFile(){
	$(document).ready(function() {
	    ...
	    $.ajax({
				...
				type: 'POST',
				dataType: 'JSON',
				data: {'data_export': jsonString,'filename':'sale_total'},
				beforeSend : function() {
				...
				complete: function(){					
					window.location = '/streak_new/sale_total.xls';					
				}
		  });
...
function import_columns(level)
  {
	 ...
	 $(document).ready(function() {
		 ...
		 {		 
			 ...
			 array_columns_choice = ['stt','streakID','name','actual_sold_value_vnd','start_date','end_date'];
			 string_columns_choice = "<th>STT</th><th>Streak ID</th><th>Campaign Name</th><th>Actual Sold Value VND</th><th>Start Date</th><th>End Date</th>";
		...
		{	
		 ...
		 $.ajax({
				url: "/streak_new/public/report/sale/total",		
				type: 'POST',
				dataType: 'JSON',
